...
class BanWords(FeatureFinder):
    def getFeatureTitle(self):
        return "BanWords"
    def getFeature(self, message):
        return len(utils.get_key_words(message))
...
def mboxtests():
    processFile("../mailbox/phishing.mbox", limit=5000)
    processFile("../mailbox/emails-enron.mbox", limit=2257, phishy=False)
